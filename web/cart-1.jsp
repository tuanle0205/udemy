				...
				<div class="row">
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							...
							<a href="cart-2.jsp" class="btn_1 full-width">Checkout</a>
							<a href="courses-grid-sidebar.jsp" class="btn_1 full-width outline"><i class="icon-right"></i> Continue Shopping</a>
						</div>
					</aside>
				</div>
				<!-- /row -->
