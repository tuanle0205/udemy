...
<body>
	...
	<header class="header menu_2">
		...
		<div id="logo">
			<a href="index.jsp"><img src="img/logo.png" width="149" height="42" data-retina="true" alt=""></a>
		</div>
		<ul id="top_menu">
			<li><a href="login.jsp" class="login">Login</a></li>
			<li><a href="#0" class="search-overlay-menu-btn">Search</a></li>
			<li class="hidden_tablet"><a href="admission.jsp" class="btn_1 rounded">Admission</a></li>
		</ul>
		<!-- /top_menu -->
			...
			<ul>
				<li><span><a href="#0">Home</a></span>
					<ul>
						...
						<li><a href="index-5.jsp">With Cookie bar (EU law)</a></li>
					</ul>
				</li>
				<li><span><a href="#0">Courses</a></span>
					<ul>
						<li><a href="courses-grid.jsp">Courses grid</a></li>
						<li><a href="courses-grid-sidebar.jsp">Courses grid sidebar</a></li>
						<li><a href="courses-list.jsp">Courses list</a></li>
						<li><a href="courses-list-sidebar.jsp">Courses list sidebar</a></li>
						<li><a href="course-detail.jsp">Course detail</a></li>
                        <li><a href="course-detail-2.jsp">Course detail working form</a></li>
						<li><a href="admission.jsp">Admission wizard</a></li>
						<li><a href="teacher-detail.jsp">Teacher detail</a></li>
					</ul>
				</li>
				<li><span><a href="#0">Pages</a></span>
					<ul>
						...
						<li><a href="agenda-calendar.jsp">Agenda Calendar</a></li>
	...
	<main>
		...
		<div id="full-slider-wrapper">
			<div id="layerslider" style="width:100%;height:750px;">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="http://via.placeholder.com/1700x750/ccc/fff/slides/slide_2.jpg" class="ls-bg" alt="Slide background">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;white-space: nowrap;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='courses-grid.jsp'>Read more</a>
				</div>
				<!-- second slide -->
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:5;">
					...
					<a class="ls-l btn_1 rounded" style="top:65%; left:50%;" data-ls="durationin:2000;delayin:1400;easingin:easeOutElastic;" href='courses-grid.jsp'>Explore</a>
				</div>
			</div>
		</div>
		<!-- End layerslider -->
		...
		<div class="container-fluid margin_120_0">
			...
			<div id="reccomended" class="owl-carousel owl-theme">
				<div class="item">
					<div class="box_grid">
						...
						<ul>
							...
							<li><a href="course-detail.jsp">Enroll now</a></li>
						</ul>
					</div>
				</div>
				<!-- /item -->
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_2.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_3.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_4.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_5.jpg" class="img-fluid" alt=""></a>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_6.jpg" class="img-fluid" alt=""></a>
							<div class="price">$54</div>
							<div class="preview"><span>Preview course</span></div>
						</figure>
						<div class="wrapper">
			...
			<!-- /carousel -->
			<div class="container">
				<p class="btn_home_align"><a href="courses-grid.jsp" class="btn_1 rounded">View all courses</a></p>
			</div>
			<!-- /container -->
			<hr>
		</div>
