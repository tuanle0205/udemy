				...
				<ul class="clearfix">
					...
					<li>
						<div class="layout_view">
							...
							<a href="courses-list.jsp"><i class="icon-th-list"></i></a>
						</div>
					</li>
					<li>
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="box_grid wow">
						<figure class="block-reveal">
							...
							<a href="course-detail.jsp"><img src="http://via.placeholder.com/800x533/ccc/fff/course__list_1.jpg" class="img-fluid" alt=""></a>
